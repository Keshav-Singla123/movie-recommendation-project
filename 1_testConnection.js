...
async function testConnections() {
  ...
  try {
    ...
    // Tip for the specific error you saw earlier
    if (err.message.includes("Illegal host")) {
      console.error("HINT: Your .env file is not loading or NEO4J_URI is missing.");
    }
  }
  ...
  try {
    ...
    if (vector.length !== 3072) {
      console.warn("Expected 3072 dimensions, got", vector.length);
    }
  } catch (err) {
