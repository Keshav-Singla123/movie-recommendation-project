...
//   2. Pinecone  → Vector Database (stores embeddings for similarity)
//   3. Gemini LLM → Language Model (understands text, creates plans)
//   4. Gemini Embeddings → Converts text to 3072-dim vectors
// =====================================================================

// BEST PRACTICE: Load env vars immediately, before any other imports
...
// =====================================================================
// DEBUG CHECK (Prevents "Illegal host" crashes)
// =====================================================================
if (!process.env.NEO4J_URI) {
  throw new Error(
    "ERROR: NEO4J_URI is undefined. \n" +
    "   1. Check if your .env file exists in the root folder.\n" +
    "   2. Check if it contains NEO4J_URI=bolt://localhost:7687 (or your Aura URI)."
  );
}
...
// 5. GEMINI EMBEDDINGS (via @google/genai SDK)
// =====================================================================
// Using gemini-embedding-001 (3072 dimensions)
// =====================================================================
